...
export class ResetPasswordComponent {
    ...
    onNewRoute(route: NavigationEvent): void {
        ...
        this.accountService.updateAccountModalType(AccountModalType.ResetPassword);
    ...
    onReset(): void {
        ...
        this.accountService.resetPassword(this.email.value, this.password.value, this.confirmPassword.value, this.token).subscribe(
            success => this.accountService.updateAccountModalType(AccountModalType.ResetPasswordConfirmation),
